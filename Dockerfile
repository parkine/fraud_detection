...
RUN apt-get -y update && \
    apt-get -y upgrade && \
    apt-get -y install \
    python3-pip cython3 python3-numpy python3-pandas \
    python3-sklearn python3-scipy python3-matplotlib jupyter-notebook unzip \
    build-essential python3-dev libatlas-base-dev \
    libopenblas-dev liblapack-dev git g++
